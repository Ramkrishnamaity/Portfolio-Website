        ...
        <div className='about-main'>
            ...
            <div className='about-text-container'>
                <p className='about-desc relative'>
                    Hello viewers, this is a brief introduction of mine. I am pursuing B.Tech from Gargi Memorial Institute of Technology. I am a full stack web developer and used different technology in web development. I started my web development journey with MERN Stack. Apart from Web technologies, i am doing programming in different languages like C, Java, Python etc. I am now at learning phase and want to explore more in this field.
                </p>
